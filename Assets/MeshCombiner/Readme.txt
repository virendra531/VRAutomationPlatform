...
This script is design to combine multiple meshes into a single mesh. To do this,
...
use this script to revert the empty game object back to normal and reactivate the child meshes.

You can save your combined meshes as prefabs. After using the combine method, a save option will be available
in the Editor, via the CombineMeshes script.
...
Your prefab, along with the mesh data that is created, will be named after your active GameObject.
